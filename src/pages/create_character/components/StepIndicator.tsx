...
const StepIndicator: React.FC<StepIndicatorProps> = ({ steps, currentStep, onStepSelect }) => {
  ...
  return (
    <Section eyebrow="Character Builder" title="Create Your Character" subtitle="Build your DaggerHeart adventurer step by step and finish with a polished final summary.">

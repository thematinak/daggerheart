...
const palette: ColorPalette = {
  gray: {
    ...
    bgHover: "hover:bg-[var(--color-gray-bg-hover)]",
    border: "border-[color:var(--color-gray-border)]",
    fill: "fill-[var(--color-gray-fill)]",
    text: "text-[var(--color-gray-text)]",
    lightText: "text-[var(--color-gray-light-text)]",
  },
  yellow: {
    bg: "bg-[var(--color-yellow-bg)]",
    bgHover: "hover:bg-[var(--color-yellow-bg-hover)]",
    border: "border-[color:var(--color-yellow-border)]",
    fill: "fill-[var(--color-yellow-fill)]",
    text: "text-[var(--color-yellow-text)]",
    lightText: "text-[var(--color-yellow-light-text)]",
  },
  blue: {
    bg: "bg-[var(--color-blue-bg)]",
    bgHover: "hover:bg-[var(--color-blue-bg-hover)]",
    border: "border-[color:var(--color-blue-border)]",
    fill: "fill-[var(--color-blue-fill)]",
    text: "text-[var(--color-blue-text)]",
    lightText: "text-[var(--color-blue-light-text)]",
  },
  green: {
    bg: "bg-[var(--color-green-bg)]",
    bgHover: "hover:bg-[var(--color-green-bg-hover)]",
    border: "border-[color:var(--color-green-border)]",
    fill: "fill-[var(--color-green-fill)]",
    text: "text-[var(--color-green-text)]",
    lightText: "text-[var(--color-green-light-text)]",
  },
  purple: {
    bg: "bg-[var(--color-purple-bg)]",
    bgHover: "hover:bg-[var(--color-purple-bg-hover)]",
    border: "border-[color:var(--color-purple-border)]",
    fill: "fill-[var(--color-purple-fill)]",
    text: "text-[var(--color-purple-text)]",
    lightText: "text-[var(--color-purple-light-text)]",
  },
  red: {
    bg: "bg-[var(--color-red-bg)]",
    bgHover: "hover:bg-[var(--color-red-bg-hover)]",
    border: "border-[color:var(--color-red-border)]",
    fill: "fill-[var(--color-red-fill)]",
    text: "text-[var(--color-red-text)]",
    lightText: "text-[var(--color-red-light-text)]",
  },
};
...
const tokens: ComponentTokens = {
  ...
  badge: "inline-flex items-center justify-center rounded-full border px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] shadow-sm transition-colors duration-200",
  card: {
